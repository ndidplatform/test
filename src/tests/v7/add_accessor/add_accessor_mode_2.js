...
describe('IdP (idp1) add accessor (mode 2) (providing custom request_message and without providing accessor_id) test', function () {
  let namespace;
  let identifier;
...
describe('IdP (idp2) add accessor (mode 2) (providing custom request_message and providing accessor_id) test', function () {
  let namespace;
  let identifier;
  let referenceGroupCode;
  ...
  before(function () {
    ...
    const identity = db.idp2Identities.find((identity) => identity.mode === 2);
    namespace = identity.namespace;
    identifier = identity.identifier;
    referenceGroupCode = identity.referenceGroupCode;
