...
describe('IdP (idp1) revoke identity association (mode 2) test', function() {
  ...
  it('Should revoke identity association successfully', async function() {
    this.timeout(10000);
  ...
  it('Identity association should be revoked successfully', async function() {
    ...
    identity = { ...identity, revokeIdentityAssociation: true };
  });
  ...
  describe('RP create request to idp that revoked identity association', function() {
  ...
  describe('RP create request and idp that revoked identity association response', function() {
    const rpReferenceId = generateReferenceId();
