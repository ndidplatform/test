...
describe('2 IdPs, min_idp = 2, accept consent, mode 3 (idp response with signature)', function() {
  before(function() {
    if (!idp2Available) {
      this.test.parent.pending = true;
      this.skip();
...
describe('2 IdPs, min_idp = 2, accept consent, mode 3 (one idp response with signature)', function() {
  before(function() {
    if (!idp2Available) {
      this.test.parent.pending = true;
      this.skip();
