...
describe('1 IdP, accept consent (idp response with signature), mode 2', function() {
  mode2And3FlowTest({
    callRpApiAtNodeId: 'rp1',
    rpEventEmitter,
    getIdentityForRequest: () => {
...
describe('1 IdP, accept consent (idp response with signature), mode 2 (without idp_id_list key and data_request_list key)', function() {
  mode2And3FlowTest({
    callRpApiAtNodeId: 'rp1',
    rpEventEmitter,
    getIdentityForRequest: () => {
