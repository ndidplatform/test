...
// describe('1 IdP, reject consent (idp response with signature), mode 3', function() {
//   mode2And3FlowTest({
//     callRpApiAtNodeId: 'rp1',
//     rpEventEmitter,
//     getIdentityForRequest: () => {
...
// describe('1 IdP, reject consent (idp response with signature), mode 3 (without idp_id_list key and data_request_list key)', function() {
//   mode2And3FlowTest({
//     callRpApiAtNodeId: 'rp1',
//     rpEventEmitter,
//     getIdentityForRequest: () => {
