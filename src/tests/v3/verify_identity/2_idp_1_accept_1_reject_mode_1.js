...
describe('2 IdPs, min_idp = 2, 1 IdP accept consent and 1 IdP reject consent mode 1 (idp response with signature)', function() {
  before(function() {
    if (!idp2Available) {
      this.test.parent.pending = true;
      this.skip();
...
describe('2 IdPs, min_idp = 2, 1 IdP accept consent and 1 IdP reject consent mode 1 (one idp response with signature)', function() {
  before(function() {
    if (!idp2Available) {
      this.test.parent.pending = true;
      this.skip();
