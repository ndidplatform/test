...
describe('1 IdP (idp response with signature), 1 AS, mode 1', function() {
  const data = JSON.stringify({
    test: 'test',
    withEscapedChar: 'test|fff||ss\\|NN\\\\|',
    arr: [1, 2, 3],
...
describe('1 IdP (idp response with signature), 1 AS, mode 1 (request_message is empty string)', function() {
  const data = JSON.stringify({
    test: 'test',
    withEscapedChar: 'test|fff||ss\\|NN\\\\|',
    arr: [1, 2, 3],
