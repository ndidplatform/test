...
import { ndidAvailable, as1Available, proxy1Available } from '..';
import {
  as1EventEmitter,
  idp1EventEmitter,
  rpEventEmitter,
...
describe('NDID disable AS node and enable AS node test', function() {
  ...
  it('After NDID disable node AS (as1) RP should create a request with request data from disabled AS (as1) unsuccessfully', async function() {
    this.timeout(15000);
    const response = await rpApi.createRequest('rp1', createRequestParams);
    const responseBody = await response.json();
    expect(response.status).to.equal(400);
  ...
  it('After NDID enable node AS (as1) RP should create a request with request data from as1 successfully', async function() {
    this.timeout(15000);
    const response = await rpApi.createRequest('rp1', createRequestParams);
    const responseBody = await response.json();
    expect(response.status).to.equal(202);
...
describe('NDID disable proxy node and enable proxy node test', function() {
  ...
  it('After NDID disable node proxy (proxy1) RP (proxy1_rp4) behind proxy should create a request unsuccessfully', async function() {
    ...
    //expect(createRequestResult.error.code).to.equal(15022); TODO:
  });
...
describe('NDID disable node AS behind proxy and enable node AS behind proxy test', function() {
  ...
  it('After NDID disable node AS behind proxy (proxy1_as4) RP should create a request with request data from disabled AS (proxy1_as4) unsuccessfully', async function() {
    this.timeout(15000);
    const response = await rpApi.createRequest('proxy1', createRequestParams);
    const responseBody = await response.json();
    expect(response.status).to.equal(400);
  ...
  it('After NDID enable node AS behind proxy (proxy1_as4) RP should create a request with request data from proxy1_as4 successfully', async function() {
    this.timeout(15000);
    const response = await rpApi.createRequest('proxy1', createRequestParams);
    const responseBody = await response.json();
    expect(response.status).to.equal(202);
