...
describe('IdP (idp1) add accessor method for revoke fail test', function() {
  let namespace;
  let identifier;
...
//revoke by idp2
describe('Revoke accessor by associated IDP but is not owner', function() {
  let namespace;
  let identifier;
  let accessorId;
  ...
  it('Revoke accessor should fail', async function() {
    const response = await idpApi.revokeAccessorMethod('idp2', {
