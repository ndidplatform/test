...
describe('mode 2, auto close on completed set to false', function () {
...
describe('mode 2, auto close on rejected set to true', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const rpCloseRequestReferenceId = generateReferenceId();
...
describe('mode 2, auto close on complicated set to true', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
...
describe('mode 2, auto close on errored set to false', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const rpCloseRequestReferenceId = generateReferenceId();
