...
describe('mode 2, auto close on completed set to off', function () {
...
describe('mode 2, auto close on rejected set to on', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const rpCloseRequestReferenceId = generateReferenceId();
...
describe('mode 2, auto close on errored set to off', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const rpCloseRequestReferenceId = generateReferenceId();
