...
describe('1 IdP, 1 AS, mode 2 (as_id_list is empty array)', function() {
  const data = JSON.stringify({
    test: 'test',
    withEscapedChar: 'test|fff||ss\\|NN\\\\|',
    arr: [1, 2, 3],
...
describe('1 IdP, 1 AS, mode 2 (without as_id_list key)', function() {
  const data = JSON.stringify({
    test: 'test',
    withEscapedChar: 'test|fff||ss\\|NN\\\\|',
    arr: [1, 2, 3],
...
describe('1 IdP, 1 AS, mode 2 (without request_params key)', function() {
  const data = JSON.stringify({
    test: 'test',
    withEscapedChar: 'test|fff||ss\\|NN\\\\|',
    arr: [1, 2, 3],
...
describe('1 IdP, 1 AS, mode 2 (with empty string request_params and request_message)', function() {
  const data = JSON.stringify({
    test: 'test',
    withEscapedChar: 'test|fff||ss\\|NN\\\\|',
    arr: [1, 2, 3],
...
// describe('1 IdP (idp response with signature), 1 AS, mode 2', function() {
//   const data = JSON.stringify({
//     test: 'test',
//     withEscapedChar: 'test|fff||ss\\|NN\\\\|',
//     arr: [1, 2, 3],
...
// describe('1 IdP (idp response with signature), 1 AS, mode 2 (with empty string request_params and request_message)', function() {
//   const data = JSON.stringify({
//     test: 'test',
//     withEscapedChar: 'test|fff||ss\\|NN\\\\|',
//     arr: [1, 2, 3],
