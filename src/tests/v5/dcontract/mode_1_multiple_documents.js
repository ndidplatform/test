...
describe('Create request (mode 1) with dcontract request type and multiple documents', function () {
  let namespace;
  let identifier;
...
${config.DCONTRACT_BASE_URL}/${dcontractTestDataWithHashArr[1].hashHex}

${config.DCONTRACT_BASE_URL}/${dcontractTestDataWithHashArr[2].hashHex}

${config.DCONTRACT_BASE_URL}/${dcontractTestDataWithHashArr[3].hashHex}`,
      min_ial: 1.1,
      min_aal: 1,
      min_idp: 1,
