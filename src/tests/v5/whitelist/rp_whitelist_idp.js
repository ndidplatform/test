...
describe('RP whitelist IdP tests', function () {
  ...
  describe('RP create request to IdP that is not whitelist (idp1) test', function () {
    ...
    describe('RP create request (not specific idp) to IdP that is not whitelist (idp1) test', function () {
      let createRequestParams;
    ...
    describe('RP create request (specific idp) to IdP that is not whitelist (idp1) test', function () {
      let createRequestParams;
    ...
    describe('RP create request (specific idp) to IdP that is not whitelist (idp1) and whitelist (idp3) test', function () {
      let createRequestParams;
    ...
    describe('RP create request (specific idp and bypass_identity_check = true) to IdP that is not whitelist (idp1) test', function () {
      let createRequestParams;
