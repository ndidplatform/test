...
describe('RP create request (mode 2) min_as = 1 and AS response with an error code (through callback)', function () {
  ...
  it('AS response with non-existent error code', async function () {
    this.timeout(15000);
...
describe('RP create request (mode 2) min_as = 1 and AS response with an error code', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const asReferenceId = generateReferenceId();
  const rpCloseRequestReferenceId = generateReferenceId();
...
describe('RP create request (mode 2) min_as = 1 to 2 AS and 1st AS response with an error code and 2nd AS response data', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const asReferenceId = generateReferenceId();
...
describe('RP create request (mode 2) min_as = 1 to 2 AS and 1st AS response data and 2nd should not response error', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const asReferenceId = generateReferenceId();
  const as2ReferenceId = generateReferenceId();
...
describe('RP create request (mode 2) min_as = 2 to 2 AS and 1st AS response data and 2nd AS response with an error', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const asReferenceId = generateReferenceId();
  const as2ReferenceId = generateReferenceId();
...
describe('RP create request (mode 2) min_as = 2 to 2 AS and 1st AS response error and 2nd AS should not response', function () {
  const rpReferenceId = generateReferenceId();
  const idpReferenceId = generateReferenceId();
  const asReferenceId = generateReferenceId();
  const as2ReferenceId = generateReferenceId();
